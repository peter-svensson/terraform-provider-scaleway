...
func TestAccObject_Basic(t *testing.T) {
	...
	bucketName := sdkacctest.RandomWithPrefix("tf-test-object-basic")
...
func TestAccObject_ContentType(t *testing.T) {
	...
	bucketName := sdkacctest.RandomWithPrefix("tf-test-object-content-type")
	resource.ParallelTest(t, resource.TestCase{
		ProtoV6ProviderFactories: tt.ProviderFactories,
		CheckDestroy: resource.ComposeTestCheckFunc(
			objectchecks.IsObjectDestroyed(tt),
...
func TestAccObject_Hash(t *testing.T) {
	...
	bucketName := sdkacctest.RandomWithPrefix("tf-test-object-hash")
	resource.ParallelTest(t, resource.TestCase{
		ProtoV6ProviderFactories: tt.ProviderFactories,
		CheckDestroy: resource.ComposeTestCheckFunc(
			objectchecks.IsObjectDestroyed(tt),
...
func TestAccObject_Move(t *testing.T) {
	...
	bucketName := sdkacctest.RandomWithPrefix("tf-test-object-move")
	resource.ParallelTest(t, resource.TestCase{
		ProtoV6ProviderFactories: tt.ProviderFactories,
		CheckDestroy: resource.ComposeTestCheckFunc(
			objectchecks.IsObjectDestroyed(tt),
...
func TestAccObject_StorageClass(t *testing.T) {
	...
	bucketName := sdkacctest.RandomWithPrefix("tf-test-object-storage-class")
	resource.ParallelTest(t, resource.TestCase{
		ProtoV6ProviderFactories: tt.ProviderFactories,
		CheckDestroy: resource.ComposeTestCheckFunc(
			objectchecks.IsObjectDestroyed(tt),
...
func TestAccObject_Metadata(t *testing.T) {
	...
	bucketName := sdkacctest.RandomWithPrefix("tf-test-object-metadata")
	resource.ParallelTest(t, resource.TestCase{
		ProtoV6ProviderFactories: tt.ProviderFactories,
		CheckDestroy: resource.ComposeTestCheckFunc(
			objectchecks.IsObjectDestroyed(tt),
...
func TestAccObject_Tags(t *testing.T) {
	...
	bucketName := sdkacctest.RandomWithPrefix("tf-test-object-tags")
	resource.ParallelTest(t, resource.TestCase{
		ProtoV6ProviderFactories: tt.ProviderFactories,
		CheckDestroy: resource.ComposeTestCheckFunc(
			objectchecks.IsObjectDestroyed(tt),
...
func TestAccObject_Visibility(t *testing.T) {
	...
	bucketName := sdkacctest.RandomWithPrefix("tf-test-object-visibility")
	resource.ParallelTest(t, resource.TestCase{
		ProtoV6ProviderFactories: tt.ProviderFactories,
		CheckDestroy: resource.ComposeTestCheckFunc(
			objectchecks.IsObjectDestroyed(tt),
...
func TestAccObject_ByContent(t *testing.T) {
	...
	bucketName := sdkacctest.RandomWithPrefix("tf-test-object-by-content")
...
func TestAccObject_ByContentBase64(t *testing.T) {
	...
	bucketName := sdkacctest.RandomWithPrefix("tf-test-object-by-content-base64")
...
func TestAccObject_Encryption(t *testing.T) {
	...
	bucketName := sdkacctest.RandomWithPrefix("tf-test-object-encryption")
	resource.ParallelTest(t, resource.TestCase{
		ProtoV6ProviderFactories: tt.ProviderFactories,
		CheckDestroy: resource.ComposeTestCheckFunc(
			objectchecks.IsObjectDestroyed(tt),
